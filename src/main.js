...
// Local optimized images — matched by deal name → filename slug
const HOURLY_DEAL_IMAGE_MAP = {
  'Kuch bhi khila de 😭': '/assets/menu/craziest-images/kuch-bhi-khila-de.png',
  'Tera jo mann wo khila de 😏': '/assets/menu/craziest-images/tera-jo-mann-wo-khila-de.png',
  'Aaj diet bhool ja 😈': '/assets/menu/craziest-images/aaj-diet-bhool-ja.png',
  'Bhook lagi hai boss 🔥': '/assets/menu/craziest-images/bhook-lagi-hai-boss.png',
  'Mehmaan nawazi special ✨': '/assets/menu/craziest-images/pet-bhar-combo.png',
  'Tera jo mann khila de 😌': '/assets/menu/craziest-images/tera-jo-mann-khila-de.png',
};
