...
const initRider = () => {
  ...
  <div style="display:flex;flex-direction:column;align-items:center;gap:20px;">
    ...
    <p style="color:#F5A800;font-size:10px;font-weight:900;letter-spacing:2.5px;text-transform:uppercase;font-family:'Space Mono',monospace;animation:lfl-text-pulse 1.4s ease-in-out infinite;">Rider Verify Ho Raha Hai…</p>
  </div>
  <style>
